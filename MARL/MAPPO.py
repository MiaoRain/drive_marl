...
# import DriveLikeAHuman.HELLM_rain
...
class MAPPO:
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        self.DriveLikeAHumanClass = DriveLikeAHumanClass( self.n_agents, self.env,)
    ...
    def interact(self):
        ...
        for i in range(self.roll_out_n_steps):
            states.append(self.env_state) #[2,4]
            driveHuman = True
            if driveHuman:
                # self.llm = self.DriveLikeAHumanClass.build_llm()
                # self.DA, self.outputParser = self.DriveLikeAHumanClass.build_agent()
                action = self.DriveLikeAHumanClass.run()
            else:
